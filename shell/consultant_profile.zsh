#!/bin/zsh
# ============================================================
# Consultant Agent Shell Profile
# ============================================================
...
# 2. Source this file: source shell/consultant_profile.zsh
...
# ============================================================
export AGET_AGENT_NAME="${AGET_AGENT_NAME:-template-consultant-aget}"
export AGET_ARCHETYPE="consultant"
...
# ============================================================
export AGET_SPEC="${AGET_AGENT_DIR}/specs/Consultant_SPEC.md"
export AGET_VOCAB="${AGET_AGENT_DIR}/specs/Consultant_VOCABULARY.md"
